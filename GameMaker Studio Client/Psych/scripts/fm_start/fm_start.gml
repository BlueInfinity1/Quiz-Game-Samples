globalvar tiltedAtLeastOnce;
tiltedAtLeastOnce = false
...
//AND ADDED e.style.marginLeft = '0px';
...
//THE BELOW THING ORIGINALLY FROM WHEN YOU FIRST ROTATE
//But actually, why should we add it to the first rotation, when it can be added here, now that the alignment constants are correct?
//if fm_mobile() or fm_maxscalex = 0
{
dj_run(@"var e = document.getElementById('gm4html5_div_id');
